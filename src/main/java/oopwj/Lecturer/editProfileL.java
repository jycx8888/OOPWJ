...
public class editProfileL extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        changePassword.setFont(new java.awt.Font("Segoe UI", 1, 14));
        ...
        IDLabel.setFont(new java.awt.Font("Segoe UI", 0, 14));
        IDLabel.setText("jLabel5");

        NameLabel.setFont(new java.awt.Font("Segoe UI", 0, 14));
        ...
        editProfilePicture.setFont(new java.awt.Font("Segoe UI", 1, 14));
    ...
    private void editProfilePictureActionPerformed(java.awt.event.ActionEvent evt) {
                if (loggedInUserID == null || loggedInUserID.trim().isEmpty()) {
